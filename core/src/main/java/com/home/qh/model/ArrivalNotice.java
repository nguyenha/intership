...
@Entity
@Table(name="arrivalNotice")
@Searchable
@Audited

public class ArrivalNotice extends BaseObject implements Serializable{
 private static final long serialVersionUID = 3832626162173359411L;
	...
	public ArrivalNotice(final String feeType, ImpBill bill) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ArrivalNotice other = (ArrivalNotice) obj;
		if (amount == null) {
