...
@Entity
@Table(name="impBillFreight")
@Searchable
@Audited

public class ImpBillFreight extends BaseObject implements Serializable{
 private static final long serialVersionUID = 3832626162173359411L;
	...
	public ImpBillFreight() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ImpBillFreight(final String feeType, ImpBill bill) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ImpBillFreight other = (ImpBillFreight) obj;
		if (amount == null) {
