...
@Entity
@Table(name="billGoods")
@Searchable
@Audited

public class BillGoods extends BaseObject implements Serializable{
 private static final long serialVersionUID = 3832626162173359411L;
	...
	public BillGoods(final String equipment, Bill bill, String commodity) {
		super();
