...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/jquery/jquery.ui.all.css'/>" />
...
<%-- 	        <div id="content" class="clearfix">
	        	<div id="left-side">
	        		<menu:useMenuDisplayer name="Velocity" config="cssVerticalMenu.vm" permissions="rolesAdapter">
	                    <menu:displayMenu name="LeftSidebar"/>
	        	...
	        	<div id="right-side">
		            ...
		            <div id="right-sub">
		                <menu:useMenuDisplayer name="Velocity" config="cssVerticalMenu.vm" permissions="rolesAdapter">
		                    <menu:displayMenu name="RightSidebar"/>
		                </menu:useMenuDisplayer>
		            </div>	        	
	        	</div>
	            ...
	            <div id="nav">
	                <div class="wrapper">
	                    ...
	                    <jsp:include page="/common/guess_menu.jsp"/>
	                </div>
	                <hr/>
	            </div><!-- end nav -->
	        </div>
